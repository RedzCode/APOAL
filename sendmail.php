    ...
    public static function SendMailConfirmation($to, $opponent, $content)
    {
        ...
        $email->addContent(
            ...
            "<p>Ici la voix...</p>" .
                ...
                '<button style="background-color: #ffd240; border-radius: 4px; color: black; font-size: 20px; text-decoration: none;" type="submit"><a href="' . $content . '"><strong>Clique ici pour valider l échange</strong></a></button>' . '
